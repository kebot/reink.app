...
export type SetLabelsMutation = { __typename?: 'Mutation', setLabels: { __typename?: 'SetLabelsError', errorCodes: Array<SetLabelsErrorCode> } | { __typename?: 'SetLabelsSuccess', labels: Array<(
      { __typename?: 'Label' }
      & { ' $fragmentRefs'?: { 'LabelFieldsFragment': LabelFieldsFragment } }
    )> } };

export type LabelFieldsFragment = { __typename?: 'Label', id: string, name: string, color: string, description?: string | null, createdAt?: any | null } & { ' $fragmentName'?: 'LabelFieldsFragment' };
